...
{
    protected $folder_directory = 'officer\\page\\citizen\\view\\';
    protected $js = ['index'];
    ...
    public function save()
    {
        ...
        $is_address_filled = !empty(trim($data_post['address'] ?? ''));

        $array_insert = [
            'name'       => $data_post['name'],
            'rw_id'      => $is_address_filled ? null : $rw_id,
            'phone'      => $data_post['phone'],
            'address'    => $is_address_filled ? $data_post['address'] : null,
