...
{
    protected $folder_directory = 'super_admin\\page\\citizen\\view\\';
    protected $js = ['index'];
    ...
    public function index()
    {
        ...
        $data['page_title'] = 'Warga | Super-Admin';
        $data['js'] = $this->js;
    ...
    public function get_data()
    {
        try {
            $citizens = $this->db->get([
                'select' => 'citizens.id, citizens.name, citizens.rw_id, citizens.created_at, citizens.updated_at',
                'from' => 'citizens',
                'join' => [
                    'rws, rws.id = citizens.rw_id'
                ],
                'where' => ['citizens.is_deleted' => 0], // Only get non-deleted records
            ])->getResult();
    ...
    public function dropdown()
    {
        ...
        'select' => 'a.*, b.name as branch_name, c.name as region_name, CONCAT(a.name, ", ", c.name) AS rw_branch',
        'from' => 'rws a',
        'where' => ['a.is_deleted' => false],
        'join' => [
