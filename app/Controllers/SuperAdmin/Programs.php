...
{
    protected $folder_directory = 'super_admin\\page\\programs\\view\\';
    protected $js = ['index'];
    ...
    public function index()
    {
        ...
        $data['page_title'] = 'Program | Super-Admin';
        $data['js'] = $this->js;
        ...
        foreach ($data_programs as $data_table) {
            ...
            $row[] = '
                <button id="btnEdit" class="btn btn-warning text-white fw-semibold" 
                    ...
                    data-branch_name="'.$data_table->branch_region.'"
    ...
    public function save()
    {
        ...
        $array_insert = [
            'name' => $data_post['name'],
            'branches_id' => $data_post['branches_id'],
    ...
    public function delete()
    {
        ...
        try {
            ...
            // Check if program is used in other tables
