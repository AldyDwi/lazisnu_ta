    ...
    public function excel()
    {
        ...
        $data_transactions = $db->table('transactions a')
            ...
            ->groupStart()
                ...
                ->where('a.rw_id IS NOT NULL)', null, false)
                ->orWhere('(g.id', $branch_id)
                ->where('a.rw_id IS NULL', null, false)
                ->where('a.user_id IS NULL)', null, false)
                ->orWhere('(i.id', $branch_id)
                ->where('a.program_id IS NULL)', null, false)
            ->groupEnd()
