...
{
    protected $folder_directory = 'admin\\page\\fund_distribution\\view\\';
    protected $js = ['index'];
    ...
    public function index()
    {
        ...
        $data['status'] = $status;
        $data['page_title'] = 'Distribusi Dana | Admin';
        $data['js'] = $this->js;
    ...
    public function list_data()
    {
        ...
        $data_transactions = DatabaseModel::get([
            'select' => 'a.*, b.name as program_name, c.name as branch_name, b.percentage',
            'from' => 'transactions a',
            'where' => [
                'a.is_deleted' => false,
                'a.type' => 'fund_distribution',
                'b.branches_id' => $branch_id,
