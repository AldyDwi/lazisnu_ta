                        ...
                        <div class="col-md-6">
                            <div class="p-3 border rounded bg-light">
                                ...
                                <div class="row g-2">
                                  ...
                                  <!-- Ranting -->
                                  <div class="col-md-4 col-6 fw-bold mb-md-3 mb-0">Ranting</div>
                                  <div class="col-md-1 col-2 text-center fw-bold mb-md-3 mb-0">:</div>
                                  <div class="col-md-7 col-12 fw-bold mb-md-3 mb-2">${user[7]}</div>

                                  <!-- RW -->
                                  <div class="col-md-4 col-6 fw-bold mb-md-3 mb-0">RW</div>
                                  <div class="col-md-1 col-2 text-center fw-bold mb-md-3 mb-0">:</div>
                                  <div class="col-md-7 col-12 fw-bold mb-md-3 mb-2">${user[8]}</div>
                              </div>
                            </div>
                        </div>
