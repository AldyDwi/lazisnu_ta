        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formEdit">
                    ...
                    <div class="mb-3">
                        <label for="EditName" class="form-label fw-bold fs-6">Nama Petugas</label>
                        <input type="text" class="form-control" id="EditName" name="name" placeholder="Tambah nama petugas">
