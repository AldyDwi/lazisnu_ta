...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?= base_url('assets/themes/admin/template/assets/img/favicon/favicon.ico'); ?>" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= base_url('assets/themes/admin/template/assets/vendor/css/pages/page-auth.css'); ?>" />
    <!-- Helpers -->
        ...
        <div class="authentication-inner">
          ...
          <div class="card shadow">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2 fw-semibold">Lupa Sandi</h4>
              <p class="mb-4 fs-5">Harap masukkan password yang baru, dan jangan lupa simpan password tersebut!</p>
              ...
              <form id="formAuthentication" class="mb-3">
                ...
                <div class="mb-3 form-password-toggle">
                    <div class="d-flex justify-content-between">
                        <label class="form-label fw-semibold" for="confirm_password">Konfirmasi Password</label>
                    </div>
                    <div class="input-group input-group-merge">
                        <input
                        type="password"
                ...
                <div class="mb-3">
                    <button class="btn btn-green d-grid w-100" type="submit">Kirim</button>
                </div>
              </form>
            </div>
          </div>
