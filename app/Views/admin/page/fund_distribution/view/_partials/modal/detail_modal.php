    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><strong>Cabang:</strong> <span id="detailBranch"></span></p>
                <p><strong>Kredit:</strong> <span id="detailCredit"></span></p>
                <p><strong>Beneficiaries:</strong></p>
                <ul id="detailBeneficiaries"></ul>
            </div>
        </div>
    </div>
</div> -->
                    ...
                    <div class="col-md-6">
                        <div class="p-3 border rounded bg-light">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-5 fw-bold">Cabang</div>
                                <div class="col-1 text-center fw-bold">:</div>
