      ...
      columns: [
        ...
        { data: 11, title: 'Tipe',
          render: function (data, type, row) {
            return data === 'fund_distribution' ? 'Distribusi Dana' : data === 'donations' ? 'Donasi' : data === 'field_officer_commision' ? 'Komisi Petugas' : 'Lainnya';
          },
         },
        { data: 1, title: 'Nama Warga', render: (data) => data ? data : '-' },
        { data: 2, title: 'Nama Petugas', render: (data) => data ? data : '-' },
        ...
        { data: 8, title: 'Catatan', visible: false, render: (data) => data ? data : '-' },
      ],
      destroy: true,
      responsive: true,
      serverside: true,
