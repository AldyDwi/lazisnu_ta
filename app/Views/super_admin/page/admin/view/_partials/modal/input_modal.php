            ...
            <div class="modal-body">
                <form id="formCreate">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="CreateName" class="form-label fw-bold fs-6">Nama Admin</label>
                                <input type="text" class="form-control" id="CreateName" name="name" placeholder="Tambah nama admin">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="CreateRW" class="form-label fw-bold fs-6">Ranting</label>
