...
<div class="container mt-4">
    <div class="card shadow-lg">
        <div class="card-body">
            <h1 class="h4 fw-bold mb-3">Data Donasi Warga</h1>
            <div class="row mb-3">
                <div class="col-md-6 d-flex align-items-center justify-content-center justify-content-md-start">
                    <button id="btnStatus" class="btn fw-semibold mb-3 mb-lg-0 px-4 btn-primary">
                        Status
                    </button>
                </div>
...
<?= $this->include($folder_directory . '_partials\\modal\\status_modal') ?>
