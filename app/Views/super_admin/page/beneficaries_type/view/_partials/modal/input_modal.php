    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formCreate">
                    <div class="mb-3">
                        <label for="CreateName" class="form-label fw-bold fs-6">Tipe Penerima</label>
                        <input type="text" class="form-control" id="CreateName" name="name" placeholder="Tambah tipe penerima">
