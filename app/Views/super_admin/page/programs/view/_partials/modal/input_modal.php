        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formCreate">
                    ...
                    <div class="mb-3">
                        <label for="CreateBranch" class="form-label fw-bold fs-6">Ranting</label>
                        <select id="CreateBranch" name="branches_id" class="form-select dropdown">
                        </select>
                        <input type="hidden" id="selectedBranch">
                        <div id="errorCreateBranch" class="invalid-feedback"></div>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="CreatePercentage" name="percentage" placeholder="Tambah persentase pengeluaran">
                        <p id="errorCreateName" class="invalid-feedback text-danger small"></p>
                    </div>
                    <div class="mb-3">
                        <label for="CreateType" class="form-label fw-bold fs-6">Pilih Jenis Program</label>
