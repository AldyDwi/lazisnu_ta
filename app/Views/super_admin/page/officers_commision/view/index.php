...
<div class="container mt-4">
    <div class="card shadow-lg">
        <div class="card-body">
            <h1 class="h4 fw-bold mb-3">Laporan Komisi Petugas Bulan Ini</h1>
            <div class="row mb-3">
                <div class="col-lg-6 d-flex align-items-center justify-content-center justify-content-lg-start">
                    <button id="btn-komisi" class="btn fw-semibold mb-3 mb-lg-0 px-4 btn-primary">
                        Komisi
                    </button>
                    <button type="button" class="btn fw-semibold mb-3 mb-lg-0 mx-2 px-4 btn-success" id="btnExcel">
                        Export Excel
                    </button>
...
<?= $this->include($folder_directory . '_partials\\modal\\comission_modal') ?>
