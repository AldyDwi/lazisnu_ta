...
$(document).on('click', '#btnEdit', function () {
  ...
  showModal('modalEdit', 'formEdit', ['EditName', 'EditRW', 'EditPhone', 'EditAddress']);
  cleave_define('#CreatePhone', 'phone');
...
$(document).on('click', '#btnDelete', function () {
  ...
  handleDelete('/super-admin/citizen/delete', id, function () {
    if (!rw_id) {
      loadDataNotRW();
    } else {
      loadData();
